...
public class DohvatiListuZeljaKorisnika {
    ...
    public static void request(KorisnikModel korisnik) {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
            ...
            try {
                Call<List<ListaZeljaModel>> call = service.getListaZeljaByIdK(idK);
                Response<List<ListaZeljaModel>> response = call.execute();
                
                System.out.println("idK, idA, datumDodavanja");
                for (ListaZeljaModel l: response.body()) {
