...
public class DohvatiKorpuKorisnika {
    ...
    public static void request(KorisnikModel korisnik) {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
            ...
            try {
                Call<List<KorpaModel>> call = service.getKorpaByIdK(idK);
                Response<List<KorpaModel>> response = call.execute();
                
                System.out.println("idK, redBr, kolicina, idA");
                for (KorpaModel k: response.body()) {
