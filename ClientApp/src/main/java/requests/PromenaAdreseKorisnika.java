 ...
 * @author Mihajlo
 */
public class PromenaAdreseKorisnika {
    ...
    public static void request(KorisnikModel korisnik) {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
            ...
            try {
                Call<String> call = service.updateLocationKorisnik(idK, idG, adresa);
                ...
                if (k != null) {
                    korisnik.setAdresa(k.getAdresa());
                    korisnik.setIdG(k.getIdG());
                }
            }
            catch (IOException e) {
