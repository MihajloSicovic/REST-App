...
public class DohvatiArtikleKorisnika {
    ...
    public static void request(KorisnikModel korisnik) {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
            ...
            try {
                Call<List<ArtikalModel>> call = service.getArtikalByIdK(idK);
                Response<List<ArtikalModel>> response = call.execute();
                
                System.out.println("idA, naziv, opis, cena, popust, idK, idKat");
                for (ArtikalModel a: response.body()) {
